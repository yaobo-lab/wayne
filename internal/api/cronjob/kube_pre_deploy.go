...
func cronjobPreDeploy(kubeCronJob *batchv1beta1.CronJob, cronjob *model.Cronjob,
	...
	if len(util.PodAnnotationControllerKindLabelKey) > 0 {
		kubeCronJob.Spec.JobTemplate.Spec.Template.Annotations[util.PodAnnotationControllerKindLabelKey] = strings.ToLower(string(model.KubeApiTypeCronJob))
	}
}
