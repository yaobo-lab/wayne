...
func newPermission(db *gorm.DB, opts ...gen.DOOption) permission {
	...
	_permission.Comment = field.NewString(tableName, "comment")
	_permission.CreateTime = field.NewTime(tableName, "create_time")
	_permission.UpdateTime = field.NewTime(tableName, "update_time")
...
func (p permissionDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) IPermissionDo {
