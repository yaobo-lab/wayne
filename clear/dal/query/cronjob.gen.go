...
func newCronjob(db *gorm.DB, opts ...gen.DOOption) cronjob {
	...
	_cronjob.MetaData = field.NewString(tableName, "meta_data")
	_cronjob.AppID = field.NewInt64(tableName, "app_id")
	_cronjob.Description = field.NewString(tableName, "description")
	_cronjob.OrderID = field.NewInt64(tableName, "order_id")
	_cronjob.CreateTime = field.NewTime(tableName, "create_time")
	_cronjob.UpdateTime = field.NewTime(tableName, "update_time")
	_cronjob.User = field.NewString(tableName, "user")
	_cronjob.Deleted = field.NewBool(tableName, "deleted")
...
func (c cronjobDo) Exists(subquery interface{ UnderlyingDB() *gorm.DB }) ICronjobDo {
