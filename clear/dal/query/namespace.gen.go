...
func newNamespace(db *gorm.DB, opts ...gen.DOOption) namespace {
	...
	_namespace.MetaData = field.NewString(tableName, "meta_data")
	_namespace.CreateTime = field.NewTime(tableName, "create_time")
	_namespace.UpdateTime = field.NewTime(tableName, "update_time")
	_namespace.User = field.NewString(tableName, "user")
	_namespace.Deleted = field.NewBool(tableName, "deleted")
	_namespace.KubeNamespace = field.NewString(tableName, "kube_namespace")
...
func (n *namespace) updateTableName(table string) *namespace {
	...
	n.MetaData = field.NewString(table, "meta_data")
	n.CreateTime = field.NewTime(table, "create_time")
	n.UpdateTime = field.NewTime(table, "update_time")
	n.User = field.NewString(table, "user")
	n.Deleted = field.NewBool(table, "deleted")
	n.KubeNamespace = field.NewString(table, "kube_namespace")
