...
func newApp(db *gorm.DB, opts ...gen.DOOption) app {
	...
	_app.NamespaceID = field.NewInt64(tableName, "namespace_id")
	_app.MetaData = field.NewString(tableName, "meta_data")
	...
	_app.User = field.NewString(tableName, "user")
	_app.Deleted = field.NewBool(tableName, "deleted")
	_app.Migrated = field.NewBool(tableName, "migrated")
...
func (a *app) updateTableName(table string) *app {
	...
	a.Migrated = field.NewBool(table, "migrated")
...
func (a *app) fillFieldMap() {
	...
	a.fieldMap["migrated"] = a.Migrated
}
