...
const TableNamePersistentVolumeClaim = "persistent_volume_claim"

// PersistentVolumeClaim mapped from table <persistent_volume_claim>
...
// TableName PersistentVolumeClaim's table name
